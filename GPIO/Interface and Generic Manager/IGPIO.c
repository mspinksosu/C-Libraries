...
in your own .c file with the function names exactly as written. For the file 
name, I usually name my .c file with an underscore prefix, such as 
GPIO_STM32G0.c or GPIO_PIC32MX.c. Don't forget to include IGPIO.h. */
