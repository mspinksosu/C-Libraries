/***************************************************************************//**
 * @brief Hardware Timer 1 Implementation (STM32F1)
 * 
 * @file HWTimer1_STM32F1.c
 * 
...
HWTimerInterface HWTimer1_FunctionTable = {
    ...
    .HWTimer_EnableComparePWM = HWTimer1_STM32_EnableComparePWM,
    .HWTimer_DisableComparePWM = HWTimer1_STM32_DisableComparePWM,
...
void HWTimer1_STM32_EnableComparePWM(uint8_t compChan)
{
    if(compChan < HW_TIM_NUM_COMP_CHANNELS)
    {
...
void HWTimer1_STM32_DisableComparePWM(uint8_t compChan)
{
    if(compChan < HW_TIM_NUM_COMP_CHANNELS)
    {
        /* Select either the upper or lower OCxM bits (0 or 1) */
