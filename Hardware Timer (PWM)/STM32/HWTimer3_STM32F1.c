/***************************************************************************//**
 * @brief Hardware Timer 3 Implementation (STM32F1)
 * 
 * @file HWTimer3_STM32F1.c
 * 
...
HWTimerInterface HWTimer3_FunctionTable = {
    .HWTimer_GetPrescaleOptions = HWTimer3_STM32_GetPrescaleOptions,
    .HWTimer_ComputePeriod = (void (*)(void *, uint32_t, uint32_t, uint16_t *))HWTimer3_STM32_ComputePeriod,
    .HWTimer_Init = (void (*)(void *))HWTimer3_STM32_Init,
    .HWTimer_GetSize = HWTimer3_STM32_GetSize,
    .HWTimer_Start = HWTimer3_STM32_Start,
    .HWTimer_Stop = HWTimer3_STM32_Stop,
    .HWTimer_Reset = HWTimer3_STM32_Reset,
    .HWTimer_IsRunning = HWTimer3_STM32_IsRunning,
    .HWTimer_SetCount = HWTimer3_STM32_SetCount,
    .HWTimer_GetCount = HWTimer3_STM32_GetCount,
    .HWTimer_AddToCount = HWTimer3_STM32_AddToCount,
    .HWTimer_GetNumCompareChannels = HWTimer3_STM32_GetNumCompareChannels,
    .HWTimer_SetCompare16Bit = HWTimer3_STM32_SetCompare16Bit,
    .HWTimer_GetCompare16Bit = HWTimer3_STM32_GetCompare16Bit,
    .HWTimer_SetComparePercent = HWTimer3_STM32_SetComparePercent,
    .HWTimer_GetComparePercent = HWTimer3_STM32_GetComparePercent,
    .HWTimer_EnableComparePWM = HWTimer3_STM32_EnableComparePWM,
    .HWTimer_DisableComparePWM = HWTimer3_STM32_DisableComparePWM,
    .HWTimer_GetOverflow = HWTimer3_STM32_GetOverflow,
    .HWTimer_ClearOverflowFlag = HWTimer3_STM32_ClearOverflowFlag,
    .HWTimer_GetCompareMatch = HWTimer3_STM32_GetCompareMatch,
    .HWTimer_ClearCompareMatchFlag = HWTimer3_STM32_ClearCompareMatchFlag,
    .HWTimer_OverflowEvent = HWTimer3_STM32_OverflowEvent,
    .HWTimer_CompareMatchEvent = HWTimer3_STM32_CompareMatchEvent,
    .HWTimer_SetOverflowCallback = HWTimer3_STM32_SetOverflowCallback,
    .HWTimer_SetCompareMatchCallback = HWTimer3_STM32_SetCompareMatchCallback,
};
...
void HWTimer3_STM32_SetCompare16Bit(uint8_t compChan, uint16_t compValue)
{
