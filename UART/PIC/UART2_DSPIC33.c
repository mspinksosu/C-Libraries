 ...
 *      UART myUART;
 *      UART_Create(&myUART, &UART2_FunctionTable);
...
/* Registers */
#define UxTXIE       _U2TXIE    // UART interrupt control TXIE and RXIE bits
#define UxRXIE       _U2RXIE
#define UxTXIF       _U2TXIF    // UART interrupt status TXIF and RXIF bits
#define UxRXIF       _U2RXIF
#define UxMODEbits   U2MODEbits // receive status and control register
#define UxSTAbits    U2STAbits  // transmit status and control register
#define UxBRG        U2BRG      // baud rate generator register
#define UxRXREG      U2RXREG    // receive data register
#define UxTXREG      U2TXREG    // transmit data register
