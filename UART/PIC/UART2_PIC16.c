...
#define RCxSTAbits   RC2STAbits   // receive status and control register
#define TXxSTAbits   TX2STAbits   // transmit status and control register
#define BAUDxCONbits BAUD2CONbits // baud rate control register
#define SPxBRGH      SP2BRGH      // baud rate generator high register
#define SPxBRGL      SP2BRGL      // baud rate generator low register
#define RCxREG       RC2REG       // receive data register
#define TXxREG       TX2REG       // transmit data register
